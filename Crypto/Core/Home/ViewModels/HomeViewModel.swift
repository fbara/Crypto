...
class HomeViewModel: ObservableObject {
    ...
    private func sortCoins(sort: SortOption, coins: inout [CoinModel]) {
        // uses 'inout' to sort the input CoinModel in place.
        switch sort {
        case .rank, .holdings:
    ...
    private func mapGlobalMarketData(marketDataModel: MarketDataModel?, portfolioCoins: [CoinModel]) -> [StatisticModel] {
        ...
        let portfolio = StatisticModel(title: "Portfolio Value", value: portfolioValue.asCurrencyWith2Decimals(), percentagChange: percentageChange)
